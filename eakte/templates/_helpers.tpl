...
*/}}
{{- define "eakte.labels" -}}
helm.sh/chart: {{ include "eakte.chart" . }}
{{ include "eakte.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "eakte.selectorLabels" -}}
app.kubernetes.io/name: {{ include "eakte.name" . }}
